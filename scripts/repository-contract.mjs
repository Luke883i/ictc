...
const required = [
  ...
  '.github/workflows/ci.yml','.github/workflows/visual.yml','.github/workflows/security.yml','.github/pull_request_template.md','.github/dependabot.yml',
...
for (const script of [
  'contract','schema:check','labels:check','epistemic:check','wiring:check','verify','e2e','visual','git:handshake','release:manifest','ascii:export','trace:preview','audit:runtime','audit:a11y','audit:docs','audit','test'
]) {
