...
function sourceLaws(s){
  ...
  return {
    ...
    orientationTransient:s.frame.includes('bindOrientationDisclosure')&&s.frame.includes("'pointerenter'")&&s.frame.includes("'pointerleave'")&&s.frame.includes("'focusin'")&&s.frame.includes("'focusout'")&&s.frame.includes("event.key!=='Escape'")&&s.frame.includes('event.detail>0'),
    ...
    proofFiveAspectGuide:s.proof.includes("grid.dataset.proofReadingGuide='five-aspects'")&&s.proof.includes("'states'")&&s.proof.includes("'provenance'")&&s.proof.includes('Stato non significa verdetto')&&s.proof.includes('Distingui origine e versione'),
...
const SOURCE_MUTANTS=[
  ...
  ['orientation-hover-lost',s=>({...s,frame:s.frame.replace("'pointerenter'","'pointerenter-retired'")})],
  ['orientation-escape-lost',s=>({...s,frame:s.frame.replace("event.key!=='Escape'","event.key!=='Escape-retired'")})],
  ...
  ['proof-reading-states-lost',s=>({...s,proof:s.proof.replace("'states'","'states-retired'")})],
  ['proof-reading-provenance-lost',s=>({...s,proof:s.proof.replace("'provenance'","'provenance-retired'")})],
...
const SCREENSHOT_SURFACES=Object.freeze([
  ...
  ['procedure-header-detail',['orientation-tokens','orientation-hover-focus-transient','reference-directly-below-header','metrics-next','context-last']],
