...
function baseline(){return {
  order:[...CANON],supportAfterPrimary:true,supportClosed:true,firstRoleAdjacent:true,contiguousDeclaredBlock:true,journeyHelperOutsideOwnedBlock:true,harmonizationReparents:false,decisionContextInsideOwnedBlock:false,staleDecisionFrames:false,legacyCompassReparents:false,
...
function violations(x){const out=[];
  ...
  if(!x.firstRoleAdjacent||!x.contiguousDeclaredBlock||!x.journeyHelperOutsideOwnedBlock||x.harmonizationReparents||x.decisionContextInsideOwnedBlock||x.staleDecisionFrames||x.legacyCompassReparents)out.push('placement-adjacency');
