...
function baseline(){return {
  order:[...CANON],supportAfterPrimary:true,supportClosed:true,
  market:['mapping','library','integrated'],libraryProgressive:true,integratedProgressive:true,
...
const essential={};
const LAW_NAMES=['editorial-order','support-progressive','market-progressive','risk-progressive','epistemic-projection','navigation','ai-optional','single-owner-primary','authority-boundary'];
