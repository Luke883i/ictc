...
const families=Object.freeze([
 ...
 ['duplicate-header-token',s=>({...s,tokens:s.tokens.replace('--chrome-header-start:#142a46;','--chrome-header-start:#142a46;--chrome-header-start:#ffffff;')})],
 ['missing-header-mid',s=>({...s,tokens:s.tokens.replace('--chrome-header-mid:#1d4068;','')})],
 ['duplicate-footer-token',s=>({...s,tokens:s.tokens.replace('--chrome-footer-start:#0d1b2f;','--chrome-footer-start:#0d1b2f;--chrome-footer-start:#ffffff;')})],
 ['footer-too-light',s=>({...s,tokens:s.tokens.replace('--chrome-footer-end:#245377;','--chrome-footer-end:#ffffff;')})],
 ['on-dark-low-contrast',s=>({...s,tokens:s.tokens.replace('--chrome-on-dark:#f8fbff;','--chrome-on-dark:#285b84;')})],
 ['muted-low-contrast',s=>({...s,tokens:s.tokens.replace('--chrome-on-dark-muted:#dbe7f5;','--chrome-on-dark-muted:#285b84;')})],
 ...
 ['target-44-removed',s=>({...s,chrome:s.chrome.replace('min-height:44px!important','min-height:32px!important')})],
