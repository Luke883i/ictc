...
try:
    with sync_playwright() as pw:
        ...
        PHASE='evidence-meaning-first';page.goto(BASE+'/?view=proof',wait_until='networkidle');ensure_onboarded(page,BASE,'admin');ready(page);reading=assert_meaning_first(page)
