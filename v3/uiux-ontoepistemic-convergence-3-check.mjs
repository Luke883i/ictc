...
assert.ok(src.ux4.includes('revealNativeTarget')&&src.ux4.includes('exact=missing.length===0')&&!src.ux4.includes('exact=missing.length===0&&hidden.length===0')&&src.ux4.includes('ictc:procedure-worklist-ready')&&src.ux4.includes('ictc:semantic-surface-request-worklists'),'R2 single work plane');
