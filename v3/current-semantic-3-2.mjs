...
const NATIVE_GATES=Object.freeze(['v3/native-semantic-lattice-3-2-check.mjs','v3/native-semantic-lattice-3-2-ui-check.mjs','v3/semantic-workspace-closure-3-2-1-saturation.mjs','v3/workspace-chrome-3-3-saturation.mjs','v3/native-semantic-lattice-3-2-saturation.mjs','v3/native-semantic-lattice-3-2-stress.mjs','v3/experience-readiness-3-2-saturation.mjs','v3/product-ci-coevolution-3-2.mjs','v3/surface-commit-3-2-v2-saturation.mjs','v3/grc-canonical-render-3-2-saturation.mjs','v3/grc-coverage-handoff-3-2-saturation.mjs','v3/ci-verdict-fanout-3-2-saturation.mjs']);
...
console.log(JSON.stringify({ok:true,suite:'current-semantic-3.2.1',baseChecks:CURRENT_SEMANTIC_ACTIVE.length,replacedLegacyDemoGates:LEGACY_DEMO_GATES.length,demoSuiteGates:DEMO_SUITE_GATES.length,policyGates:POLICY_GATES,nativeGates:NATIVE_GATES,releaseProfile:'semantic_foundation_3_0+demo_suite_2_2_projection_closure+native_semantic_lattice_3_2+semantic_workspace_closure_3_2_1+workspace_chrome_3_3'}));
