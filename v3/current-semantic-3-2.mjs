...
console.log(JSON.stringify({ok:true,suite:'current-semantic-3.2.1',extensionOf:'current-release-suite semantic',policyGates:POLICY_GATES,nativeGates:NATIVE_GATES,releaseProfile:'semantic_foundation_3_0+native_semantic_lattice_3_2+semantic_workspace_closure_3_2_1'}));
