...
const handlers=[createWorkOrchestration({store,permissions}),createProcessLandscapeHandler({store,permissions}),createManualMonitoringHandler({store,permissions}),createManualAssuranceHandler({store,permissions}),createInsightRuntime({store,permissions}),createWorkbenchProjection({store,permissions}),createGrcRuntime({store,permissions}),createMonitoringJobHandler({store,permissions}),monitoring.handle,createContributionHandler({store,permissions}),createIncidentHandler({store,permissions}),createEvidenceHandler({store:evidenceStore,permissions}),createAdminHandler({store,permissions,posture:runtimePosture})];
