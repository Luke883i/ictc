...
const PRODUCT_EDITION='1.1 stable · Enterprise Candidate';
const PRODUCT_NAME='Integrated Compliance Tower Control';
const STABILITY_PROFILE='1.1_stable';
