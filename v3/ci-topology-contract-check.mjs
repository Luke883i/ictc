...
check(uiux.includes("#procedureHub .procedure-card")&&uiux.includes("PHASE='proof-to-ep-navigation'")&&uiux.includes("[data-service=\"proof\"]")&&uiux.includes("[data-service=\"epistemic\"]"),'required UI/UX oracle must retain catalogue and canonical Proof-to-EP browser coverage after information-value delegation');
