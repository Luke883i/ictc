...
try:
 with sync_playwright() as pw:
  ...
  for code,label in LABELS.items():
   card=page.locator(f'#procedureHub [data-process-code="{code}"]'); expect(card.locator(':scope > footer .procedure-primary')).to_have_text(label); signals=card.locator(':scope > footer .procedure-signals');
