...
PROCEDURES=[
 {'code':'RN-01','id':'monitoring','root':'#monitoringView','frame':'#monitoringView > .procedure-frame','work':'#monitoringView > .section-block','context':'#monitoringView > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"]','anatomy':'#monitoringView > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'EC-01','id':'incidents','root':'#incidentsView','frame':'#incidentsView > .procedure-frame','work':'#incidentsView > .section-block','context':'#incidentsView > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"]','anatomy':'#incidentsView > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'AO-01','id':'objects','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'MC-01','id':'coverage','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'AP-01','id':'actions','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'RC-01','id':'risks','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'AR-01','id':'assurance','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > .procedure-frame > .procedure-support-rail > [data-editorial-slot="advanced-context"] > .procedure-anatomy'}]
