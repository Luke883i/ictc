...
PROCEDURES=[
 {'code':'RN-01','id':'monitoring','root':'#monitoringView','frame':'#monitoringView > .procedure-frame','work':'#monitoringView > .section-block','context':'#monitoringView > [data-editorial-slot="advanced-context"]','anatomy':'#monitoringView > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'EC-01','id':'incidents','root':'#incidentsView','frame':'#incidentsView > .procedure-frame','work':'#incidentsView > .section-block','context':'#incidentsView > [data-editorial-slot="advanced-context"]','anatomy':'#incidentsView > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'AO-01','id':'objects','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'MC-01','id':'coverage','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'AP-01','id':'actions','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'RC-01','id':'risks','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > [data-editorial-slot="advanced-context"] > .procedure-anatomy'},
 {'code':'AR-01','id':'assurance','root':'#grcWorkspace','frame':'#grcWorkspace > .procedure-frame','work':'#grcWorkspace > .grc-body','context':'#grcWorkspace > [data-editorial-slot="advanced-context"]','anatomy':'#grcWorkspace > [data-editorial-slot="advanced-context"] > .procedure-anatomy'}]
...
def audit_proof(page,role,vp,width):
 ...
 for name,disclosure in [('epistemic-investigation',investigation),('trace-reconstruction',trace),('decisions',decisions)]:
  ...
  elif disclosure.get_attribute('open') is not None:anomaly('evidence-workspace-open-by-default',role,vp,'proof',name,'collapsed')
