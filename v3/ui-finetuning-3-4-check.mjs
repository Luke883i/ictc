...
if(issues.length){console.error(JSON.stringify({ok:false,suite:'ui-finetuning-3.4',issues},null,2));process.exit(1);}console.log(JSON.stringify({ok:true,suite:'ui-finetuning-3.4',tasks:{chrome:true,home:true,proof:true,processCatalogue:true},scope:'header+footer+Home summary+Evidence header/lattice entry+process catalogue only',ownersPreserved:['stable-shell.js','proof-workspace-3-2.js','procedure-frame.js'],claimBoundary:'Static semantic/presentation contract; not human usability research, aesthetic certification, WCAG certification or legal assessment.'}));
