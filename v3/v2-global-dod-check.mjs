...
assert.equal(contract.experienceMetrics.grcProcessCoverage,1);
console.log(`v2-global-dod-check: V2 capability DoD preserved under ${contract.productEdition}; exact-head CI remains external merge gate`);
