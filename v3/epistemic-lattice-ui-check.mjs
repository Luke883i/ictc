...
assert.ok(proofWorkspace.includes('data-proof-workspace="epistemic-investigation"')&&proofWorkspace.includes('data-service="epistemic"')&&proofWorkspace.includes("root.dataset.proofReadingOrder='facts>decisions>trace>evidence-basis>epistemic>external>integrity>method>export'")&&proofWorkspace.includes('ordered(content,[factStrip,decisions,trace,standards,investigation'),'Proof workspace must own the canonical progressive EP-01 entry after fact/decision/evidence meaning');
