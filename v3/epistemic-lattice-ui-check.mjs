...
assert.ok(proofWorkspace.includes('data-proof-workspace="epistemic-investigation"')&&proofWorkspace.includes('data-service="epistemic"')&&proofWorkspace.includes("root.dataset.proofReadingOrder='facts>method>decisions>trace>evidence-basis>epistemic>external>integrity>export'")&&proofWorkspace.includes('ordered(content,[factStrip,interpretation,decisions,trace,standards,investigation'),'Proof workspace must own the canonical progressive EP-01 entry after the reading criteria');
