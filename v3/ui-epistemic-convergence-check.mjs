...
console.log('ui-epistemic-convergence-check: ok reversible revision/digest-bound envelopes + transition-safe projection + connected drag geometry + drag/click separation + shared control geometry');
