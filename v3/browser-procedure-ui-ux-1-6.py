...
PROCESS_READY={
    ...
    'MC-01':"()=>{const r=document.querySelector('#grcWorkspace'),m=r?.querySelector('[data-editorial-slot=\"metrics\"] [data-procedure-metrics=\"coverage\"]'),f=r?.querySelector('[data-grc-form=\"mapping\"]'),d=r?.querySelector('.procedure-decision-frame .composition-process-context');return !!(m&&f&&d&&r.dataset.editorialOrderValid==='true');}",
