...
try:
    with sync_playwright() as pw:
        ...
        PHASE='MC-status-context-stability';page.evaluate("()=>document.dispatchEvent(new CustomEvent('ictc:context-changed',{detail:{surface:'grc',procedureId:'coverage',reason:'browser-owner-stability'}}))");page.wait_for_timeout(80);assert page.evaluate("()=>window.__mcStatusNode===document.querySelector('#grcWorkspace .grc-kpis[data-editorial-support=\"process-status\"]')")
