...
def metrics(page,label):
 ...
 RESULTS.append({'oracle':'normal-flow-non-overlap','reflow':'reflow-1440-390-320','rootTrap':'root-trap-negative','case':label,**data})
