...
ok('proof-post-render-semantic-owner',/MutationObserver/.test(runtime)&&/semanticOwnership=['"]visual-epistemic-runtime['"]/.test(runtime)&&/title\?\.textContent!==['"]Postura ICTC['"]/.test(runtime)&&/qualifier\?\.textContent!==['"]Prove e limiti del funzionamento ICTC['"]/.test(runtime)&&/characterData:true/.test(runtime));
