...
for(const interceptor of ['installAiOptionalControls();','installRiskActionFidelity();'])assert.ok(active.indexOf(interceptor)<active.indexOf('installGrcWorkspace();'),`${interceptor} must own its human checkpoint before base GRC click handling`);
...
console.log('v1-stable-ui-contract-check: ok (3 surfaces, 7 processes, 5 disclosure levels, thin canonical shell and single checkpoint ownership)');
