...
const report={schemaVersion:'1.1.0',model:model.model,baselineCommit:model.baselineCommit,verdict:openFindings.some(item=>item.severity==='critical')?'enterprise-materialization-required':'refinement-required',facts,findingCount:findings.length,openFindingCount:openFindings.length,findings,dimensions,minimumRuntimePath:model.minimumRuntimePath,certificationBoundary:model.certificationBoundary};
