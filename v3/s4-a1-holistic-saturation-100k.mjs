...
function validate(id,row,p,role){
 ...
 if(role==='auditor'){if(t?.intendedAction!=='inspect-record'||row.canAct!==false)v.push('auditor-write-leak');}else if(t?.intendedAction!==row.primaryAction)v.push('action-intent-drift');
