...
const directSemantic=['v3/procedure-finetuning-2-3-check.mjs','v3/procedure-record-contract-2-4-check.mjs','v3/surface-truth-contract-2-5-check.mjs','v3/shell-admin-demo-check-2-6.mjs','v3/semantic-closure-2-8-causality-check.mjs','v3/semantic-closure-2-8-ui-check.mjs','v3/semantic-closure-2-8-saturation.mjs','v3/runtime-stabilization-semantic-check.mjs','v3/runtime-stabilization-2-9-saturation.mjs'];
...
console.log(JSON.stringify({ok:true,semanticChecks:CURRENT_SEMANTIC.length,runtimeChecks:CURRENT_RUNTIME.length,uniqueChecks:paths.length,coverageFamilies:Object.keys(ASSURANCE_COVERAGE_CONTRACT).length,procedureFineTuningContract:'2.4.0',surfaceTruthContract:'2.5.0',shellAdminDemoContract:'2.6.0',semanticClosureContract:'2.8.0',runtimeStabilizationContract:'2.9.0',versionedGateAttribution:'direct'}));
