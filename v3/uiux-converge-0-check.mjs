...
const [contractRaw,closureRaw,entryRaw,tokens,icons,shell,frame,native,enterprise,closureCss,compositionCss,registry]=await Promise.all([
  ...
  read('./public/enterprise-workspace-3-2.css'),read('./public/semantic-workspace-closure-3-2-1.css'),read('./public/semantic-composition-3-1.css'),read('./current-gate-registry.mjs')
]);
