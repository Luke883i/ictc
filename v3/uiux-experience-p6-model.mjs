...
export function validateP6(contract){
  ...
  const ai=contract?.aiStatus||{};if(ai.readyLabel!=='AI pronta'||ai.notReadyLabel!=='AI non attiva'||ai.readyIcon!=='sparkles'||ai.attentionIcon!=='triangle-alert')errors.push('ai-status');
