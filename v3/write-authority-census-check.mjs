...
assert.equal(isProductionSource('v3/control-test-check.mjs'),false);assert.equal(isProductionSource('v3/semantic-closure-census.mjs'),false);
...
console.log('write-authority-census-check: ok (production classification + duplicate-owner falsifier)');
