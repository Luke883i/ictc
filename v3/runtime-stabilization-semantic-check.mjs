...
assert.deepEqual(effect('insight.human.validated').families,['decided']);
...
console.log(`runtime-stabilization-semantic-check: ok (compatibilityActions=${Object.keys(COMPATIBILITY_ACTION_SEMANTICS).length}, unknownPromotion=0)`);
