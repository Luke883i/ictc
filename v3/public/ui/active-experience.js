...
export function installActiveExperience(){if(installed)return;installed=true;installStableShell();installProofSurface();installTraceExplorer();installGrcWorkspace();installSurfaceRouter();installBindings();installAdminCenter();installProcedureAdmin();installEnterpriseExperience();installFi01Reference();installGlobalTools();installAiOptionalControls();installProcessHandoffs();installRiskActionFidelity();installStableProfileMenu();updateStableProfileMenu();renderStableChrome();document.addEventListener('ictc:rendered',renderStableChrome);}
