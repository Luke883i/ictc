...
function ensureSurface() {
  ...
  main.insertAdjacentHTML('beforeend', `<section id="proofView" class="view proof-view" hidden tabindex="-1" aria-labelledby="proofTitle"><header class="proof-head proof-hero"><div><p class="eyebrow">Assurance read-only</p><h1 id="proofTitle">${esc(SURFACE_LABELS.proof)}</h1><p>${esc(PRODUCT_COPY.proofLead)}</p></div><div class="proof-hero-note"><b>Leggi dal generale al dettaglio</b><span>Cosa osserviamo → come lo proviamo → cosa manca → limiti</span></div></header><div id="proofLoading" class="proof-state" role="status">Caricamento della postura…</div><div id="proofError" class="proof-state boundary" role="alert" hidden></div><div id="proofContent" hidden><section class="proof-snapshot" aria-label="Sintesi postura"><article><span>Decisioni umane</span><b id="evidenceDecisionCount">0</b><small>nel perimetro visibile</small></article><article><span>Processi con decisioni</span><b id="evidenceProcessCount">0</b><small>su 7 Processi di Compliance</small></article><article><span>Integrità registrata</span><b id="proofIntegrity">—</b><small>coerenza tecnica osservabile</small></article><article><span>Ambito di lettura</span><b id="evidenceActor">—</b><small>non amplia i permessi</small></article></section><section class="proof-reading-grid"><article class="proof-reading-card"><p class="eyebrow">Osservabile</p><h2>Cosa ICTC può mostrare</h2><p>Decisioni, ricevute, versioni, relazioni, controlli runtime e provenienza effettivamente registrati.</p></article><article class="proof-reading-card"><p class="eyebrow">Da completare</p><h2>Quale evidenza manca</h2><p id="proofReadinessLimit">Un controllo senza evidenza resta non verificato.</p></article><article class="proof-reading-card proof-reading-boundary"><p class="eyebrow">Confine</p><h2>Cosa ICTC non conclude</h2><p id="proofBoundary"></p></article></section><section class="proof-method" aria-labelledby="proofMethodTitle"><header><p class="eyebrow">Metodo di prova</p><h2 id="proofMethodTitle">Come ICTC dimostra la propria postura</h2><p>Ogni promessa deve essere collegata a una pratica osservabile, a una prova e a un limite esplicito.</p></header><ol id="proofEvidenceKinds" class="proof-method-list"></ol><p id="proofRule" class="proof-inline-boundary"></p></section><details class="proof-section" open><summary><span><b>Decisioni e tracciabilità</b><small>La traccia umana più recente nel perimetro accessibile</small></span></summary><div class="proof-section-body"><div id="evidenceDecisionList" class="evidence-decision-list"></div><p class="proof-inline-boundary">Un hash o un fascicolo dimostra una registrazione tecnica, non la sufficienza sostanziale della prova.</p></div></details><details class="proof-section"><summary><span><b>Runtime e integrità</b><small>Release, ruolo e controlli tecnici osservabili</small></span></summary><div class="proof-section-body"><section class="proof-metrics" aria-label="Postura tecnica"><article><span>Release</span><b id="proofRelease">—</b></article><article><span>Ruolo</span><b id="proofActor">—</b></article><article><span>Controlli runtime</span><b id="proofRuntime">—</b></article></section></div></details><details class="proof-section"><summary><span><b>Deployment e requisiti esterni</b><small>Prove che il repository non può sostituire</small></span></summary><div class="proof-section-body"><ul id="proofDeploymentGaps" class="proof-list"></ul></div></details><details class="proof-section"><summary><span><b>Standard dichiarati e riferimenti</b><small>Pratica + evidenza + limite, mai certificazione</small></span></summary><div class="proof-section-body"><div id="proofBenchmarkMappings" class="proof-mappings"></div><div id="translationMappings" class="proof-mappings"></div></div></details><details class="proof-section"><summary><span><b>Export della vista corrente</b><small>Gli export mantengono lo stesso perimetro di lettura</small></span></summary><div class="proof-section-body"><div class="proof-actions"><button id="downloadViewCsv" class="secondary" type="button">CSV</button><button id="downloadViewJson" class="secondary" type="button">JSON</button><button id="refreshProof" class="secondary" type="button">Aggiorna postura</button></div><p class="proof-inline-boundary">I fascicoli di singolo oggetto sono disponibili in PDF, XML, Markdown e ZIP dai relativi Processi di Compliance.</p></div></details></div></section>`);
}
...
function renderProof(data, revision = currentRevision()) {
  ...
  $('#proofRule').textContent = data.proof?.rule || 'Ogni promessa deve mostrare pratica, evidenza e limite.';
