...
function renderProof(data, revision = currentRevision()) {
  ...
  $('#proofIntegrity').textContent = integrity.ok ? `Catena integra · r${integrity.revision || 0}` : 'Integrità da verificare';
