...
export const labels = {
  candidate:'Da verificare', verified:'Verificata', rejected:'Scartata', superseded:'Superata', draft:'Piano pronto', active:'Attivo', paused:'In pausa',
...
function actionLabel(action) {
  const map = {'settings.updated':'Configurazione registrata','monitoring.mission.drafted':'Piano registrato','monitoring.mission.activated':'Monitoraggio attivato','monitoring.run.completed':'Run registrato','catalog.source.decided':'Decisione registrata','contribution.recorded':'Materiale preservato','contribution.enriched':'Materiale classificato','incident.intake.recorded':'Racconto preservato','incident.analyzed':'Analisi registrata','incident.answers.recorded':'Risposta registrata','incident.draft.generated':'Formulazione registrata','incident.submitted':'Segnalazione inviata','incident.closed':'Segnalazione chiusa'};
