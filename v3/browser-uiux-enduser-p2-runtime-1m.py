...
SPECS={
 ...
 'monitoring':dict(view='monitoring',root='#monitoringView',identity=':scope > .procedure-frame h1',primary_scope=':scope > .procedure-frame .procedure-frame-actions',primary='[data-enduser-primitive="PrimaryAction"]',secondary=':scope > .procedure-frame details[data-secondary-disclosure="true"]',boundary=':scope > .procedure-frame .procedure-orientation-token[data-enduser-primitive="BoundaryNote"]',record='.procedure-work-item.p2-record-row',count='[data-primary-count-owner="true"]',legacy=':scope > .hero > .hero-copy'),
 'incidents':dict(view='incidents',root='#incidentsView',identity=':scope > .procedure-frame h1',primary_scope=':scope > .procedure-frame .procedure-frame-actions',primary='[data-enduser-primitive="PrimaryAction"]',secondary=':scope > .procedure-frame details[data-secondary-disclosure="true"]',boundary=':scope > .procedure-frame .procedure-orientation-token[data-enduser-primitive="BoundaryNote"]',record='.procedure-work-item.p2-record-row',count='[data-primary-count-owner="true"]',legacy=':scope > .hero > .hero-copy'),
 'objects':dict(view='grc',procedure='objects',root='#grcWorkspace',identity=':scope > .procedure-frame h1',primary_scope=':scope > .procedure-frame .procedure-frame-actions',primary='[data-enduser-primitive="PrimaryAction"]',secondary=':scope > .procedure-frame details[data-secondary-disclosure="true"]',boundary=':scope > .procedure-frame .procedure-orientation-token[data-enduser-primitive="BoundaryNote"]',record='.grc-list > article.p2-record-row',count='[data-primary-count-owner="true"]',metric='.grc-kpis[data-metric-role="distribution"]'),
 'coverage':dict(view='grc',procedure='coverage',root='#grcWorkspace',identity=':scope > .procedure-frame h1',primary_scope=':scope > .procedure-frame .procedure-frame-actions',primary='[data-enduser-primitive="PrimaryAction"]',secondary=':scope > .procedure-frame details[data-secondary-disclosure="true"]',boundary=':scope > .procedure-frame .procedure-orientation-token[data-enduser-primitive="BoundaryNote"]',record='.grc-list > article.p2-record-row',count='[data-primary-count-owner="true"]',metric='.grc-kpis[data-metric-role="distribution"]'),
 'actions':dict(view='grc',procedure='actions',root='#grcWorkspace',identity=':scope > .procedure-frame h1',primary_scope=':scope > .procedure-frame .procedure-frame-actions',primary='[data-enduser-primitive="PrimaryAction"]',secondary=':scope > .procedure-frame details[data-secondary-disclosure="true"]',boundary=':scope > .procedure-frame .procedure-orientation-token[data-enduser-primitive="BoundaryNote"]',record='.grc-list > article.p2-record-row',count='[data-primary-count-owner="true"]',metric='.grc-kpis[data-metric-role="distribution"]'),
 'risks':dict(view='grc',procedure='risks',root='#grcWorkspace',identity=':scope > .procedure-frame h1',primary_scope=':scope > .procedure-frame .procedure-frame-actions',primary='[data-enduser-primitive="PrimaryAction"]',secondary=':scope > .procedure-frame details[data-secondary-disclosure="true"]',boundary=':scope > .procedure-frame .procedure-orientation-token[data-enduser-primitive="BoundaryNote"]',record='.grc-list > article.p2-record-row',count='[data-primary-count-owner="true"]',metric='.grc-heat[data-metric-role="analysis"]'),
