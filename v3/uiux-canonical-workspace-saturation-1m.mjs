...
const SOURCE_MUTANTS=Object.freeze([
  ...
  ['decision-frame-breaks-owned-block',s=>({...s,harmonizationBase:s.harmonizationBase.replace("if(primary&&!frameAfterPrimary)primary.after(frame)","const rail=root.querySelector(':scope > .procedure-support-rail');if(rail)rail.after(frame)")})],
