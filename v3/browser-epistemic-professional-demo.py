...
def open_epistemic(page,phase_prefix='open-epistemic'):
 ...
 PHASE=f'{phase_prefix}-posture'; page.locator('.service-nav [data-service="proof"]').click(); expect(page.locator('#proofView')).to_be_visible(); expect(meta).to_be_visible()
