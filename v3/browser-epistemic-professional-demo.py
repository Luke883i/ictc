...
try:
    ...
    with sync_playwright() as pw:
        ...
        open_epistemic(page,'explore-overview-entry');PHASE='explore-overview';expect(page.locator('.epistemic-overview')).to_be_visible();expect(page.locator('.epistemic-level-nav')).to_contain_text('Quadro');shot(page,'epistemic-use-explore-overview.png')
