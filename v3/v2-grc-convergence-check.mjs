...
console.log(`v2-grc-convergence-check: ok (V2 contracts and relations preserved under ${contract.productEdition}; MC evolved to Standard e Controlli without losing mapping capability)`);
