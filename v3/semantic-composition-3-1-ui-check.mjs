...
check(harmonization.includes('composition-process-context'),'process decision/evidence/boundary must be progressive disclosure');
...
check(runtime.includes('summary.hidden=true')&&runtime.includes("root.querySelector('#epistemicCompression')?.remove()"),'EP-01 numeric/technical compression must not precede relationship work');
