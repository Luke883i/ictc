...
for(const token of ['normalizeMissingValues','Motivazione · non registrata','stateAxis','organizational-use','controlEffect=\'pagination\''])assert.ok(stateProjection.includes(token),`state projection missing ${token}`);
