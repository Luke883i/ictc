...
const SHARED_KEYS=Object.freeze(['work-orchestration','process-landscape','process-handoffs','insights','workbench','procedure-invariant','review-needs','epistemic-lattice','epistemic-inference','evidence','admin']);
