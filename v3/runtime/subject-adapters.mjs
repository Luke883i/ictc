...
function generic(type,collection,procedureId=null){return{type,procedureId:procedureId||procedureIdForSubject(type),canonicalizationVersion:'subject-record-v1',resolve(state,subject){return byId(state?.[collection],subject?.id);},canonicalize:clean};}
const ADAPTERS=[
  ...
  generic('epistemic-derivation','epistemicDerivations','epistemic-lattice'),
  generic('epistemic-inference-run','epistemicInferenceRuns','epistemic-lattice')
