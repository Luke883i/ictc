...
assert.match(styles,/@import url\('\.\/experience-1-9\.css'\);/);assert.match(styles,/@import url\('\.\/refined-product\.css'\);/);
assert.match(css,/data-ictc-experience-edition="1\.9-experience-candidate"/);assert.match(css,/@media\(prefers-reduced-motion:reduce\)/);
