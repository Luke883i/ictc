...
| `EC-01` | Gestione eventi e segnalazioni | Registrare fatti, raccogliere chiarimenti, governare versioni, invii e chiusure. | Originale, allegati, domande, risposte, formulazioni, decisioni, versioni e receipt. | Non determina automaticamente obblighi, responsabilità o qualificazioni giuridiche. |
| `EV-01` | Evidenze e controlli | Consultare controlli applicativi, limiti, provenienza e stato delle prove. | Stato dei controlli, azioni richieste, versioni, digest, limiti e artefatti macchina. | Non costituisce certificazione o approvazione di un’autorità esterna. |
