...
4. documenti di candidate/DoD per il lavoro in corso;
...
Per il flusso operativo completo: `docs/DEVELOPMENT.md`. Per la candidate corrente: `docs/PR60_GLOBAL_DOD.md`. Per la storia: `docs/PROJECT_TRAJECTORY.md`.
